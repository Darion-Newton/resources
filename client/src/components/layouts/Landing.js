...
class Landing extends Component {
  ...
  <div className="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
    <span className="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">File Name</span>
    <span class="font-semibold mr-2 text-left flex-auto">Click here for your excellent free file  <button onClick={this.clickHandler}
                  className=" font-semibold rounded-tl-3xl rounded-br-3xl uppercase text-center px-5 py-3 shadow-md my-4 lg:mb-0 bg-gray-900 text-yellow-50 hover:bg-gray-700 focus:ring-4 focus:ring-yellow-300">reset</button> </span>
            ...
            <div>
              ...
              <form name="contact" data-netlify="true" netlify-honeypot="bot-field" method="POST" autocomplete="off" >
                ...
                <button onClick={this.clickHandler} type="submit" id="submit-button"
                  className="w-full font-semibold rounded-tl-3xl rounded-br-3xl uppercase text-center px-5 py-3 shadow-md my-4 lg:mb-0 bg-gray-900 text-yellow-50 hover:bg-gray-700 focus:ring-4 focus:ring-yellow-300">Free Resource</button>
